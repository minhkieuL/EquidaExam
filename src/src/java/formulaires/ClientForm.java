	...
	public Client getClient(HttpServletRequest request) {
		...
		if (nom == null) {
			...
			if (nom.length() < 3 || nom.length() > 40) {
				ajouterErreur(nomChampNom, "La longueur du nom doit être compris entre 3 et 40 charactères");
			}
		}
		...
		if (prenom == null) {
			...
			if (prenom.length() < 3 || prenom.length() > 40) {
				ajouterErreur(nomChampPrenom, "La longueur du prénom doit être compris entre 3 et 40 charactères");
			}
		}
		...
		if (rue == null) {
			...
			if (rue.length() < 3 || rue.length() > 60) {
				ajouterErreur(nomChampRue, "La longueur de la rue doit être compris entre 3 et 60 charactères");
			}
		}
		...
		if (copos == null) {
			...
			if (copos.length() > 5) {
				ajouterErreur(nomChampCopos, "La longueur du code postal ne peut excéder 5 charactères");
			}
		}
